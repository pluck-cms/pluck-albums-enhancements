							...
							<tr>
								<td>
									<a href="<?php echo PAGE_URL_PREFIX.CURRENT_PAGE_SEONAME.ALBUM_URL_PREFIX.$album; ?>" title="album <?php echo $album_name; ?>">
										<img alt="<?php echo $album_name; ?>" title="<?php echo $album_name; ?>" src="<?php echo SITE_URL; ?>/data/modules/albums/albums_getimage.php?image=<?php echo $album; ?>/thumb/<?php echo album_random_image($album); ?>" />
									</a>
								</td>
								<td>
									...
									<span class="albumdescs">
										<?php echo htmlspecialchars_decode($album_desc); ?>
									</span>
								</td>
							</tr>
						</table>
