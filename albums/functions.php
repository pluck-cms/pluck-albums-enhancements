		...
		foreach ($albums as $album) {
			?>
				<div class="menudiv">
					...
					<span>
						<a href="?module=albums&amp;page=modifyalbum&amp;var1=<?php echo $album['seoname']; ?>">
							<img src="data/image/settings.png" title="<?php echo $lang['albums']['edit_album']; ?>" alt="<?php echo $lang['albums']['edit_album']; ?>" />
						</a>
					</span>
					<span>
...
/**
* Return random image from an album
* @param string $album The album name
*/
function album_random_image($album) {
	$images = albums_get_images($album);
	if ($images != FALSE) {
		$images = $images[rand(0,count($images)-1)];
		return $images['filename_image'];
	}
}
?>